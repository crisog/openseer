...
const (
	...
	HealthServiceName = "openseer.v1.HealthService"
)
...
const (
	...
	HealthServiceCheckProcedure = "/openseer.v1.HealthService/Check"
)

// HealthServiceClient is a client for the openseer.v1.HealthService service.
type HealthServiceClient interface {
	Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error)
}

// NewHealthServiceClient constructs a client for the openseer.v1.HealthService service. By default,
...
func NewHealthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) HealthServiceClient {
	...
	healthServiceMethods := v1.File_openseer_v1_health_proto.Services().ByName("HealthService").Methods()
...
// Check calls openseer.v1.HealthService.Check.
...
// HealthServiceHandler is an implementation of the openseer.v1.HealthService service.
...
func NewHealthServiceHandler(svc HealthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/openseer.v1.HealthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedHealthServiceHandler) Check(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("openseer.v1.HealthService.Check is not implemented"))
}
